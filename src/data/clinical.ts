...
export const clinicalNote =
  "I'm a firm believer that textbooks don't show you what a procedure or clinical workflow actually looks like in practice. I shadow to see how a team moves through a case, where the pace slows because of a bottleneck with the technology, which steps take more attention, and where patient outcomes could be improved with better technology. Even in a well-equipped hospital, the gaps are there, and that's something you can really only see by shadowing first-hand. Since I come from a bioengineering background, I look at things from a biodesign perspective and shadow for the purposes of identifying unmet clinical needs."
/**
...
export const hospitalPhotos: WorkPhoto[] = [
  ...
  },
  {
    ...
    caption:
      "Simulation & skills training lab for the Fundamentals of Laparoscopic Surgery exam at Stanford Hospital",
  ...
  },
  {
    ...
    caption: "Intern cohort at El Camino Hospital",
    bold: "El Camino Hospital",
    aspect: 1.5,
  },
  {
    ...
    caption:
      "Intern cohort after receiving training on the Da Vinci machine at El Camino Hospital",
    bold: "El Camino Hospital",
    aspect: 1.333,
  },
  {
    ...
    caption: "Learning how to do laparoscopic surgery at Stanford Hospital",
    bold: "Stanford Hospital",
    aspect: 1.333,
  },
  {
    ...
    caption: "Medical training simulation lab at Stanford Hospital",
    bold: "Stanford Hospital",
    aspect: 1.333,
  },
  {
    ...
    caption:
      "Post-shadowing a pediatric cardiothoracic surgery at Lucile Packard Children's Hospital",
  ...
  },
  {
    ...
    caption: "OR at Stanford Hospital",
    bold: "Stanford Hospital",
    aspect: 1.338,
  },
  {
    ...
    caption: "Shadowing in the emergency department at Stanford Hospital",
    bold: "Stanford Hospital",
    aspect: 0.748,
  },
  {
    ...
    caption: "Working a 12 hour shift at Stanford Hospital",
    bold: "Stanford Hospital",
    aspect: 0.747,
  },
  {
    ...
    caption: "Shadowing in the neurosurgery OR at Stanford Hospital",
    bold: "Stanford Hospital",
    aspect: 1.341,
  },
  {
    ...
    caption: "Learning to use the Da Vinci machine at Stanford Hospital",
    bold: "Stanford Hospital",
    aspect: 1.334,
  },
  {
    ...
    caption: "Using the Da Vinci machine at El Camino Hospital",
    bold: "El Camino Hospital",
    aspect: 0.75,
  },
  {
    ...
    caption:
      "Practicing a laparoscopic surgery using the Da Vinci machine at El Camino Hospital",
    bold: "El Camino Hospital",
    aspect: 0.5625,
  },
];
